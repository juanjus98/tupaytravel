                     ...
                     <tr>
                       <th colspan="4"><i class="fa fa-list"></i> Eventos
                         ...
                         <span class="pull-right">
                          <a href="#" class="btn btn-info btn-xs" id="btn-agregar-detalle-servicio">
                                ...
                                if (!empty($detalles_titulo)) {
                                  foreach ($detalles_titulo as $index => $titulo) {
                                    ...
                                    <tr class="row-table-rm">
                                      ...
                                      <td>
                                      <!-- <input type="text" name="detalles[descripcion][]" class="form-control input-sm" placeholder="Descripción" value="<?php echo $detalles_descripcion[$index]; ?>"> -->
                                      <textarea name="detalles[descripcion][]" rows="3" class="form-control input-sm" placeholder="Descripción"><?php echo $detalles_descripcion[$index]; ?></textarea>
                                      </td>
                                      <td>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                    <!-- <input type="text" name="detalles[descripcion][]" class="form-control input-sm" placeholder="Descripción"> -->
                                    <textarea name="detalles[descripcion][]" rows="3" class="form-control input-sm" placeholder="Descripción"></textarea>
                                    </td>
                                    <td>
                                      <a href="#" class="btn btn-danger btn-xs btn-quitar-tr">Quitar <span class="glyphicon glyphicon-minus-sign" aria-hidden="true"></span></a>
                                    </td>
              ...
              <table class="table table-bordered">
               ...
               <table class="table table-bordered">
                 ...
                 <table class="table table-bordered">
                   <thead class="thead-default">
                     <tr>
                       <th><i class="fa fa-list"></i> Imagen Servicio</th>
                     </tr>
                   </thead>
                   <tbody>
                     <tr>
