                            ...
                            if(!empty($listado)){
                                foreach ($listado as $key => $item) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <a href="<?php echo base_url($this->config->item('galeria_upload_path') . $item['imagen']); ?>" class="strip" data-strip-caption="<?php echo $item['nombre']; ?>" target="_blank"><?php echo $item['imagen']; ?></a>
                                        </td>
                                        ...
                                        <td><?php echo $item['nombre_galeria']; ?></td>
