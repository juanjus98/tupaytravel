    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <form name="frm-buscar" id="frm-buscar" method="post" action="" role="search">
                    <div class="row pad" style="padding-bottom: 0px;">
                        ...
                        <div class="col-sm-2">
                            <a href="<?php echo base_url('waadmin/tours_itinerario/index/'.$this->tour_id.'?refresh');?>" class="btn btn-default btn-sm" title="Restablecer"><i class="fa fa-undo" aria-hidden="true"></i> Restablecer </a>
                        </div>

                        <div class="col-sm-5">
                            <div class="pull-right">
                                <a href="<?php echo base_url('waadmin/tours_itinerario/editar/C/null/' . $this->tour_id);?>" class="btn btn-success btn-sm" title="Agregar"><i class="fa fa-plus-circle" aria-hidden="true"></i> Agregar </a>
            ...
            <div class="box-body table-responsive">
                <form name="index_form" id="index_form" action="<?php echo base_url(); ?>waadmin/tours_itinerario/eliminar/<?php echo $this->tour_id;?>" method="post">
                            ...
                            if(!empty($listado)){
                                foreach ($listado as $key => $item) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url(); ?>waadmin/tours_itinerario/editar/V/<?php echo $item['id']; ?>/<?php echo $this->tour_id; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="Visualizar"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                            <a href="<?php echo base_url(); ?>waadmin/tours_itinerario/editar/E/<?php echo $item['id']; ?>/<?php echo $this->tour_id; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="Editar"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                    <?php
                                }
