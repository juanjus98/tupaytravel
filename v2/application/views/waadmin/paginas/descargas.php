    ...
    <div class="panel panel-default">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="pull-right">
                        ...
                        <a href="<?php echo base_url(); ?>waadmin/paginas/descargas" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span> Cancelar</a>
                    </div>
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <textarea name="resumen" id="resumen" class="form-control" rows="5" placeholder="Resumen"><?php echo $post['resumen']; ?></textarea>
                </div>
            ...
            <div class="form-group">
                <label for="url_video" class="col-sm-2 control-label">Link de descarga:</label>
                <div class="col-sm-5">
                    <input type="text" name="url_video" id="url_video" class="form-control"  placeholder="Link de descarga" value="<?php echo $post['url_video']; ?>">
                </div>
