    ...
    <div class="row">  
      ...
      <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
        <div class="bg-form">
          ...
          <h3 class="text-center">¡Mensaje enviado!</h3>
            <p class="description">
              Tu mensaje ha sido enviando satisfactoriamente, en breve nos estaremos comunicando con usted para responder sus consultas.
            </p>
            <div class="text-center"> 
