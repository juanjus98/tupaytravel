...
<div class="btn-group btn-group-justified" role="group" aria-label="...">
  ...
  <a href="#" class="btn btn-precio"><?php echo $paquete['precio'];?>/Persona</a>
  </div>
  <div class="btn-group" role="group">
  <a href="<?php echo $url_paquete;?>" title="<?php echo $nombre_paquete;?>" class="btn btn-detalles"><i class="fa fa-plus" aria-hidden="true"></i> Información</a>
  </div>
</div>
                </div>
                </div>
