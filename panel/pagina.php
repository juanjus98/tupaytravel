...
<body background="../images/fondo.jpg">
  ...
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="listado_paginas.php"><strong>Páginas</strong></a></li>
...
<div class="panel-body">
  <div class="row">    
    <?php 
    $sql="SELECT * from tblpagina where id='".$_GET['id']."'";
    ...
    ?>
    <form class="form-horizontal" method="post" action="modelpagina.php" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-3">
          <input name="url" type="text" class="form-control" id="url" value="<?php echo MURL.'p/';?>" disabled>
        </div>
        <div class="col-sm-4">
          <input name="url_key" type="text" class="form-control" id="url_key" value="<?php echo $row['url_key'];?>">
        </div>
      </div>

      <div class="form-group">
        <label for="descripcion" class="col-sm-2 control-label">Detalles:</label>
        <div class="col-sm-8">
          <textarea name="descripcion" rows="5" id="descripcion" ><?php echo $row['descripcion'];?></textarea>
          <script>
          var editor = CKEDITOR.replace("descripcion<?php echo $j?>");
           CKFinder.setupCKEditor( editor, "../panel/ckfinder/" );
         </script>
       </div>
     </div>
