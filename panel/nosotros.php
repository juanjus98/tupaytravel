            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="pull-right">
                        ...
                        <a href="<?php echo base_url(); ?>waadmin/paginas/home" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span> Cancelar</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="tab-content tab-wa">
                    <div role="tabpanel" class="tab-pane active" id="tab-1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <!--<input type="text" name="descripcion1" id="descripcion1" class="form-control"  placeholder="Titulo 1" value="<?php echo $post['descripcion1']; ?>">-->
                                <?php echo $this->ckeditor->editor('descripcion1', $post['descripcion1']); ?>
                            </div>
