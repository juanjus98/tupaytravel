  ...
  <head>
    ...
                    type:  'post',
                    success:  function (response) {
                       window.location.href='listado_videos.php'; 
                    }
              });
          });
...
<div class="container">
 ...
 <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="listado_videos.php"><strong>Videos</strong></a></li>
  ...
  <button type="button" id="nuevo" class="btn btn-primary" aria-label="Left Align">
                <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Nuevo Video
  </button>
  <div class="row col-lg-offset-5">
              
              <h3>Listado de Videos</h3></div>
  <div class="row">
      <table class="table-striped table table-condensed table-responsive" id="listado">
        ...
        <tbody>
    <?php 
     $sql="SELECT * from tblvideos Where estado != 0";
     ...
     while($row=  mysql_fetch_array($res))
     {
        echo '<tr id="'.$row['id'].'">
         ...
         <td><a href="'.$row['url'].'" target="_blank"><img src="'.$row['imagen'].'" class="img-responsive" style="max-height: 60px;"></a></td>
