  ...
  <head>
    ...
    <script>
       $(document).ready(function(){
           $('table#listado').on('click','button#editar',function(){
              ...
              window.location.href='tour.php?id='+$id; 
           });
    ...
                    type:  'post',
                    success:  function (response) {
                       window.location.href='listado_tour.php'; 
                    }
              });
          });
...
<div class="container">
 ...
 <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    <ul class="nav navbar-nav">
        ...
        <li><a href="listado_tours.php"><strong>Tours</strong></a></li>
  ...
  <button type="button" id="nuevo" class="btn btn-primary" aria-label="Left Align">
                <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Nuevo Tour
  </button>
  <div class="row col-lg-offset-5">
              
              <h3>Listado de Tours</h3></div>
  <div class="row">
