...
//          inner join tblfotos on tblhotel.id_hotel=tblfotos.id_hotel
    ...
    ?>
    <form class="form-horizontal" method="post" action="modelvideo.php" enctype="multipart/form-data">
      
      <div class="form-group">
        <label for="url" class="col-sm-2 control-label">URL Youtube:</label>
        <div class="col-sm-8">
          <input name="url" type="text" class="form-control" id="url" value="<?php echo $row['url'];?>" autofocus="">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <textarea name="descripcion" class="form-control" id="descripcion" ><?php echo $row['descripcion'];?></textarea>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-3">
          <input name="orden" type="text" class="form-control" id="orden" value="<?php echo $row['orden'];?>" autofocus="">
        </div>
      </div>
