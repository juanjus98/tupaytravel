...
<div class="container">
 ...
 <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="listado_promociones.php"><strong>Promociones</strong></a></li>
  ...
  <div class="row col-lg-offset-5">
              ...
              <h3>Listado de promociones</h3></div>
  <div class="row">
      <table class="table-striped table table-condensed table-responsive" id="listado">
        ...
        <tbody>
    <?php 
     $sql="SELECT * from tblpromociones Where estado != 0";
     ...
     while($row=  mysql_fetch_array($res))
     {
        echo '<tr id="'.$row['id'].'">
         ...
         <td><a href="../images/uploads/'.$row['imagen'].'" target="_blank"><img src="../images/uploads/'.$row['imagen'].'" class="img-responsive" style="max-height: 60px;"></a></td>
