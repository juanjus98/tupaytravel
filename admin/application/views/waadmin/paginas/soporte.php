...
<form name="frm-editar" id="frm-editar" method="post" action="" class="form-horizontal" enctype="multipart/form-data">
    ...
    <div class="panel panel-default">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="pull-right">
                        ...
                        <a href="<?php echo base_url(); ?>waadmin/paginas/soporte" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span> Cancelar</a>
                    </div>
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <label for="resumen" class="col-sm-2 control-label">Descargar Skype:</label>
                <div class="col-sm-5">
                    <input type="text" name="resumen" id="resumen" class="form-control"  placeholder="Descargar Skype" value="<?php echo $post['resumen']; ?>">
                </div>
                <?php echo form_error('resumen'); ?>
            </div>
            
            <div class="form-group">
                <label for="imagen_2" class="col-sm-2 control-label">Descargar Teamviewer:</label>
                <div class="col-sm-5">
                    <input type="text" name="imagen_2" id="imagen_2" class="form-control"  placeholder="Descargar Teamviewer" value="<?php echo $post['imagen_2']; ?>">
                </div>
                <?php echo form_error('imagen_2'); ?>
            </div>
            
            <div class="form-group">
                <label for="imagen_3" class="col-sm-2 control-label">Link a Preguntas Frecuentes:</label>
                <div class="col-sm-5">
                    <input type="text" name="imagen_3" id="imagen_3" class="form-control"  placeholder="Link a Preguntas Frecuentes" value="<?php echo $post['imagen_3']; ?>">
                </div>
                <?php echo form_error('imagen_3'); ?>
            </div>
