  ...
  new google.translate.TranslateElement({pageLanguage: 'es', layout: google.translate.TranslateElement.InlineLayout.SIMPLE}, 'google_translate_element');
        ...
        <div class="row">
            <div class="col-sm-8">
                ...
                <?php 
                $sql="SELECT count(tblpaquete_tour.id_paquete) as cant,tblpaquete_tour.id_paquete,tblpaquete.nombre as name,tblpaquete.orden
...
//                   }
                       ...
                       <div class="row">
                           <input name="id_paquete" id='id_paquete' type="hidden" value="<?php echo $com['id_paquete']?>" >
                            <div class="col-sm-6 pull-right" style="margin-top: 10px;">
                                <button id="<?php echo $com['id_paquete']?>" class="btn btn-primary pull-right" type="submit">Ver Detalles</button>
                            </div>
                        </div>
                       </form>                       
                    </div>
 ...
 <footer>
	<hr>	
        <div class="row" >
            <div class="col-md-1"><a href="index.php">Inicio</a> |
